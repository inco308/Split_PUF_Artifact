...
configurations with $k \geq 4$ within the trainable data range.  Data
...
\parbox{0.9\columnwidth}{\footnotesize $^\dagger$LR on 8-XOR data could
not be trained due to memory constraints (6M samples $\times$ 64 features
exceed the closed-form solver's capacity on a 12~GB GPU).  Reported standard
deviations are sample standard deviations.}
\tablefloatend
