...
\begin{itemize}
    ...
    $\sim 6.6 \times 10^6$ CRPs for 8-XOR (logistic fit), and
    ...
    effective security level relative to our XOR APUF scaling law and confirm
    Wisiol's characterization that splitting reduces iPUF security to roughly
    the $\max\{k_{\text{up}},k_{\text{down}}\}$-XOR level (\S\ref{sec:ipuf}).
