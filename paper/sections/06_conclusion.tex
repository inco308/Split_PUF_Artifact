...
10^5$ CRPs for 2-XOR to $\sim 6.6 \times 10^6$ CRPs for 8-XOR, with a
...
claims suggest.  A $(4,4)$-iPUF, claimed comparable to a 6-XOR APUF, is
...
with the $\max\{k_{\text{up}}, k_{\text{down}}\}$-XOR level established by
